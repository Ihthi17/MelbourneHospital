    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <li class="nav-item">
          <a href="View_PCR_Booking.php" class="nav-link">
          <i class="fa-regular fa-calendar-check"></i>
            <p>
               View PCR Booking
        ...
        <li class="nav-item">
          <a href="View_Payment_Details.php" class="nav-link">
          <i class="fa-regular fa-calendar-check"></i>
            <p>
        ...
        <li class="nav-item">
          <a href="view_time_schedule.php" class="nav-link">
          <i class="fa-regular fa-calendar-check"></i>
            <p>
               View Doctor ChangeTime
